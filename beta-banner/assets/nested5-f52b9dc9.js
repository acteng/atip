import{S as se,i as ae,s as oe,B as le,g as i,c as X,j as n,q as re,k as ce,l as ue,m as Z,n as t,p as pe,t as ee,e as te,o as he,f as ie,r as de,u as me}from"./stores-9a9b8ad8.js";import{H as be}from"./Header-ed28ca5e.js";function ge(H){let e,a,W,o,M,l,q,c,_,u,N,p,L,h,B,d,I,m,P,b,Y,g,R,f,j,v,G,y,V,w,D,C,F,A,J,T,O,x,z,k,K,S,Q,$,U,E,r;return a=new be({}),o=new le({}),{c(){e=i("div"),X(a.$$.fragment),W=n(),X(o.$$.fragment),M=n(),l=i("h1"),l.textContent="Plan Your Active Travel Schemes Accessibility Statement",q=n(),c=i("p"),c.textContent=`This accessibility statement applies to the Plan Your Active Travel Schemes
    ...
    interactions with maps.`,N=n(),p=i("ul"),p.innerHTML=`<li>We include multiple options for basemap, allowing the user to decide what
      ...
       has advice on making your device easier to use if you have a disability</li>`,L=n(),h=i("h2"),h.textContent="How accessible this website is",B=n(),d=i("p"),d.textContent="We know some parts of the website are not fully accessible:",I=n(),m=i("p"),m.textContent=`This website is run by Active Travel England. It requires use of and
    interactions with maps.`,P=n(),b=i("ul"),b.innerHTML=`<li>You cannot navigate most of the website using just a keyboard</li> <li>You cannot navigate most of the website using speech recognition software</li> <li>You cannot listen to most of the website using a screen reader (including
      ...
      issue.</li>`,Y=n(),g=i("h2"),g.textContent="Feedback and contact information",R=n(),f=i("p"),f.innerHTML=`If you need information on this app or to provide further feedback on issues
    ...
    .`,V=n(),w=i("h2"),w.textContent="Technical information about this website’s accessibility",D=n(),C=i("p"),C.textContent=`Active Travel England is committed to making its website accessible, in
    accordance with the Public Sector Bodies (Websites and Mobile Applications)
    (No. 2) Accessibility Regulations 2018.`,F=n(),A=i("h2"),A.textContent="Compliance status",J=n(),T=i("p"),T.textContent=`This website is not compliant with the Web Content Accessibility Guidelines
    ...
    against WCAG guidelines.`,re(l,"margin-top","30px"),ce(e,"class","govuk-width-container govuk-prose")},m(s,ne){ue(s,e,ne),Z(a,e,null),t(e,W),Z(o,e,null),t(e,M),t(e,l),t(e,q),t(e,c),t(e,_),t(e,u),t(e,N),t(e,p),t(e,L),t(e,h),t(e,B),t(e,d),t(e,I),t(e,m),t(e,P),t(e,b),t(e,Y),t(e,g),t(e,R),t(e,f),t(e,j),t(e,v),t(e,G),t(e,y),t(e,V),t(e,w),t(e,D),t(e,C),t(e,F),t(e,A),t(e,J),t(e,T),t(e,O),t(e,x),t(e,z),t(e,k),t(e,K),t(e,S),t(e,Q),t(e,$),t(e,U),t(e,E),r=!0},p:pe,i(s){r||(ee(a.$$.fragment,s),ee(o.$$.fragment,s),r=!0)},o(s){te(a.$$.fragment,s),te(o.$$.fragment,s),r=!1},d(s){s&&he(e),ie(a),ie(o)}}}function fe(H){return de(async()=>{me()}),[]}class ve extends se{constructor(e){super(),ae(this,e,fe,ge,oe,{})}}document.body.className+=" js-enabled"+("noModule"in HTMLScriptElement.prototype?" govuk-frontend-supported":"");new ve({target:document.getElementById("app")});
