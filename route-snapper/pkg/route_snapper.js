...
export class JsRouteSnapper {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JsRouteSnapper.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_jsroutesnapper_free(ptr);
    }
    /**
    ...
    */
    constructor(map_bytes) {
        try {
            ...
            wasm.jsroutesnapper_new(retptr, ptr0, len0);
            ...
            return JsRouteSnapper.__wrap(r0);
        } finally {
    ...
    */
    renderGeojson() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsroutesnapper_renderGeojson(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    toFinalFeature() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.jsroutesnapper_toFinalFeature(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v0;
            if (r0 !== 0) {
    ...
    */
    onClick() {
        wasm.jsroutesnapper_onClick(this.ptr);
    }
    /**
    * @returns {boolean}
    */
    onDragStart() {
        const ret = wasm.jsroutesnapper_onDragStart(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {boolean}
